---
title: "ARA: Shiny Learning Session I"
...
[http://apsld0058:3838/r-shiny-20-Jan-17/ara-shiny-presentation.html#/](http://apsld0058:3838/r-shiny-20-Jan-17/ara-shiny-presentation.html#/). 

- All code for examples and creating these slides are on Codehub: 

[https://codehub.optum.com/payment-integrity-analytics/shiny-server/tree/master](https://codehub.optum.com/payment-integrity-analytics/shiny-server/tree/master). 
...
- deploying apps on our server using Shiny Server
    ...
    + [ARA Shiny Server FAQ](http://wiki.optum.com/display/ARA/Shiny+Server)
...
- Confluence page: [http://wiki.optum.com/display/ARA/Shiny+Server](http://wiki.optum.com/display/ARA/Shiny+Server). 


FAQ (related to Shiny Server and deployment) 

- [http://wiki.optum.com/display/ARA/Shiny+Server](http://wiki.optum.com/display/ARA/Shiny+Server+FAQ). 
